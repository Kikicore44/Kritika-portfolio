        ...
        <div className="grid md:grid-cols-2 gap-12">
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="bg-black/30 border border-border/30 rounded-xl px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary/50 focus:outline-none transition-colors"
              />
              <input
                placeholder="Email"
                value={form.email}
            ...
            <input
              ...
              className="w-full bg-black/30 border border-border/30 rounded-xl px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary/50 focus:outline-none transition-colors"
            />
            <textarea
              placeholder="Message"
              rows={5}
              ...
              className="w-full bg-black/30 border border-border/30 rounded-xl px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary/50 focus:outline-none transition-colors resize-none"
            />
          ...
          <div className="space-y-4">
            {socials.map((social) => (
              <div
                key={social.name}
                className="flex items-center gap-4 p-4 rounded-xl bg-black/30 border border-border/30 hover:border-primary/30 transition-colors cursor-pointer"
              >
