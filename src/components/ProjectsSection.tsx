...
const projects = [
  { title: "Watch E-commerce Website", tech: "HTML/CSS/Javascript", desc: "A responsive watch showcase website developed using HTML, CSS, and JavaScript. It presents products in a clean and organized layout with interactive elements for better user engagement. The design focuses on smooth navigation and a modern shopping experience. This project helped build a strong foundation in front-end development and UI structuring.", color: "from-indigo-600/20 to-blue-500/20", rotate: "-2deg", image: undefined },
  { title: "Gym Management System", tech: "React/Node.js/MongoDB", desc: "A desktop-based gym management system built using Java with an object-oriented approach. It allows managing member details, attendance, and membership status efficiently. The system is designed to reduce manual work and organize records in a structured way. This project improved understanding of classes, objects, and GUI-based application design.", color: "from-indigo-600/20 to-blue-500/20", rotate: "-2deg", image: undefined },
  { title: "Wine E-commerce Website", tech: "Figma", desc: "An elegant wine website designed using Figma with a strong focus on visual layout and user experience. The design includes well-structured pages, attractive product sections, and smooth user flow. High-fidelity UI elements and consistent color themes are used to enhance aesthetics. This project developed skills in UI/UX design and prototyping.", color: "from-indigo-600/20 to-blue-500/20", rotate: "1.5deg", image: "src/assets/wine e-commerece.png" },
  { title: "Hotel Website", tech: "React", desc: "A modern hotel booking interface designed in Figma with user-friendly navigation and clean layouts. It focuses on creating a smooth booking experience through clear structure and visual hierarchy. The design includes multiple sections like homepage, rooms, and booking flow. This project improved skills in wireframing and user-centered design.", color: "from-indigo-600/20 to-blue-500/20", rotate: "-1deg", image: "src/assets/Hotel website.png" },
